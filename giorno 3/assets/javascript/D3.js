...
for( let i=0; i<starWarsCharacters.length; i++ ){
  ...
  switch (starWarsCharacters[i].eye_color){
    ...
    break;
    case 'gray' :
    eyeColor.gray.push(starWarsCharacters[i]);
    break;
    case 'blue-gray' :
    eyeColor["blue-gray"].push(starWarsCharacters[i]);
    break;
    default:
      console.log('colore occhi non definito');
}
}
...
}else if (crewMass >100 ){
  console.log('Danger! Overload alert: escape from this ship');
}else{
